import { getContactPageContentApi } from "@/apiConfig/services";
...
export async function generateMetadata({ params, searchParams }, parent) {
    ...
    try {
        ...
        const id = getPageId(PAGES_KEY.CONTACT, menuCookie?.value);
        const { data } = await getContactPageContentApi(id) || {};
        return {
